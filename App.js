...
const restauratList =[
    {
        ...
        "data": {
          ...
          "cityState": "3",
          "address": "4-1-365/F TO F4,E1 TO E3,D1 TO D3, G&F FLOORS,PAPAJI ENCLAVE,REDDY HOTEL ROAD,BOGGULKUNTA,HYDERABAD,TELANGANA",
      ...
      },
      {
        ...
        "data": {
          ...
          "lastMileTravel": 6.5,
          "slugs": {
            "restaurant": "papadams-blue-near-pvt-market-kothapet-kothapet-dilsukhnagar",
            "city": "hyderabad"
          },
          "cityState": "3",
...
const RestaurantCard = () => {
    return (
        ...
        restauratList[1].data?.cloudinaryImageId 
        } 
        />
            <h2>{restauratList[0].data?.name} </h2>
            <h3>{restauratList[0].data?.cuisines.join(" , ")}</h3>
            <h4>{restauratList[0].data?.lastMileTravel} minutes  </h4>
        </div>
    );
};
...
const Body = () => {
    return(
        <div className="restaurant-list">
            ...
            <RestaurantCard  restaurant = {restauratList[0]}/>
            <RestaurantCard restaurant = {restauratList[1]} />
            <RestaurantCard  restaurant = {restauratList[2]}/>
            <RestaurantCard  restaurant = {restauratList[3]}/>
        </div>
    )
}
const Footer = () => {
